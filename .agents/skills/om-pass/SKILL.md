---
name: om-pass
description: Acceptance loop — grade product vs each requirement (test/agent+debate), write conformance.md, loop until 100% met. Use after >om-check passes when requirements.md exists.
---
