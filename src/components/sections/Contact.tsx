    ...
    <SectionWrapper id="contact">
      <div className="mx-auto max-w-2xl">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg text-content-muted">Có câu hỏi? Gửi tin nhắn, chúng tôi sẽ phản hồi sớm nhất.</p>
        </div>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="mt-12 space-y-6" noValidate>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-content-secondary">Tên</label>
                <input
                  id="name"
                  type="text"
                  value={form.name}
            ...
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-content-secondary">Tin nhắn</label>
              <textarea
                id="message"
                rows={5}
                value={form.message}
