...
- **P5: Content Validation** (cross-check against .omni/sdlc/content-source.md) — HIGH=BLOCKING, LOW/MEDIUM=ADVISORY
...
1. Read `.omni/sdlc/content-source.md` — extract `## Facts` and `## Forbidden Content`.
