...
*Critical Note: Any attempt to bypass the planning steps (>om:brainstorm or >om:plan) to write code immediately MUST be rejected. Any attempt to run >om:ship before >om:check passes MUST be rejected.*
