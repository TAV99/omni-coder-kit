...
1. `.omni/design-spec.md` — original architecture intent
2. `.omni/todo.md` — what was planned vs completed
3. `.omni/test-report.md` — what was verified working
...
## Tech Stack
[List with brief justification from .omni/design-spec.md]
...
- Do NOT document features that were not implemented (check .omni/todo.md completion status).
