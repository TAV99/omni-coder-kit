...
|---------|--------------|---------------|
| `>om-scan` | `.omni/workflows/onboard-workflow.md` | @Codebase for legacy project scan |
| `>om-think` | `.omni/workflows/requirement-analysis.md` | @Codebase for project scan |
| `>om-skill` | `.omni/workflows/skill-manager.md` | @Web for skill discovery |
...
| `>om-memo` | `.omni/workflows/knowledge-learn.md` | @Git for fix history |

### Cursor Native Tools Integration

| Cursor Feature | When to Use | Omni Integration |
|---|---|---|
| @Codebase | Before >om-think, >om-plan | DNA detection context |
...
- **[>om-think]:** Solutions Architect. Uses @Codebase for project scan, then adaptive interview. Outputs `.omni/sdlc/design-spec.md`.
- **[>om-skill]:** Skill Manager. Reads tech stack from `.omni/sdlc/design-spec.md`, proposes expert skills from skills.sh.
...
- **[>om-memo]:** Knowledge Capture. Auto-records lessons after successful fixes into `.omni/knowledge/knowledge-base.md`.
