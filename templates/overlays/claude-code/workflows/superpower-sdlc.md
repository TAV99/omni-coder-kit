...
| `>om-spec` | `/om-spec` | Main session | `.omni/workflows/intake.md` |
| `>om-pass` | `/om-pass` | Main session + sub-agents (debate) | `.omni/workflows/acceptance.md` |
| `>om-scan` | `/om-scan` | Main session | `.omni/workflows/onboard-workflow.md` |
| `>om-think` | `/om-think` | Main session | `.omni/workflows/requirement-analysis.md` |
| `>om-skill` | `/om-skill` | Main session | `.omni/workflows/skill-manager.md` |
