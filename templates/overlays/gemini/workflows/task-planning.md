...
When executing [>om:plan], you transform `.omni/sdlc/design-spec.md` into actionable tasks.
...
Maintain the `.omni/sdlc/todo.md` file as the secondary source of truth and for quick checkbox access.
Format:
```markdown
# Todo — [Project Name]
