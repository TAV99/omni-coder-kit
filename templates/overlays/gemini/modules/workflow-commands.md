...
| `>om-spec` | `.omni/workflows/intake.md` | `ask_user`, `save_memory` (sinh requirements.md) |
| `>om-pass` | `.omni/workflows/acceptance.md` | `run_shell_command` + cross-model debate |
| `>om-scan` | `.omni/workflows/onboard-workflow.md` | `ask_user`, `save_memory` |
| `>om-think` | `.omni/workflows/requirement-analysis.md` | `ask_user`, `save_memory` |
| `>om-skill` | `.omni/workflows/skill-manager.md` | `google_web_search` |
...
| `>om-memo` | `.omni/workflows/knowledge-learn.md` | `save_memory` |
