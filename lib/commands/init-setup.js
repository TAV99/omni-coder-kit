...
const {
    ...
    buildGeminiModules, buildGeminiBootstrapContent, buildStrictnessBlock,
} = require('../init');
...
module.exports = { setupClaudeAdvanced, setupCodexAdvanced, setupCursorAdvanced, setupWindsurfAdvanced, setupGeminiAdvanced };
