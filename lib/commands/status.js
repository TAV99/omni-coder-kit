...
function handleCommands() {
    ...
    const commands = [
        ...
        { cmd: '>om:intake',     slash: '/om-intake',     role: 'Acceptance', desc: 'Spec/Q&A khách hàng → .omni/sdlc/requirements.md (checklist nguyên tử)' },
        { cmd: '>om:accept',     slash: '/om-accept',     role: 'Acceptance', desc: 'Chấm sản phẩm vs từng requirement (test/agent+debate) → conformance.md; lặp tới 100%' },
