...
async function handleInit(options) {
    ...
    if (response.ide === 'windsurf') {
        await setupWindsurfAdvanced(manifest, response.ide, initFiles, parsedRules, rulesContent, response.strictness, fileName);
    }

    if (response.ide === 'gemini') {
        await setupGeminiAdvanced(manifest, response.ide, initFiles, parsedRules, rulesContent, response.strictness, fileName);
    }

    if (response.ide === 'antigravity') {
        await setupAntigravityAdvanced(manifest, response.ide, initFiles, parsedRules, rulesContent, response.strictness, fileName);
    }
