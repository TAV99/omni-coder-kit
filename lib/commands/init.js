...
async function handleInit(options) {
    ...
    if (response.ide === 'antigravity') {
        await setupAntigravityAdvanced(manifest, response.ide, initFiles, parsedRules, rulesContent, response.mode, fileName);
    }
