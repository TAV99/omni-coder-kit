...
const STATES = Object.freeze([
    'INIT', 'BRAINSTORM', 'EQUIP', 'PLAN', 'COOK', 'CHECK', 'FIX', 'DOC', 'SHIP', 'DONE', 'BLOCKED',
]);
...
const PIPELINE = Object.freeze(['INIT', 'BRAINSTORM', 'EQUIP', 'PLAN', 'COOK', 'CHECK', 'DOC', 'SHIP', 'DONE']);
...
const TRANSITIONS = Object.freeze({
    ...
    PLAN: ['COOK', 'BLOCKED'],
    COOK: ['CHECK', 'BLOCKED'],
    CHECK: ['FIX', 'COOK', 'DOC', 'BLOCKED'], // fail→FIX, pass+more→COOK, pass+done→DOC
    FIX: ['CHECK', 'BLOCKED'],
    DOC: ['SHIP', 'BLOCKED'],
    SHIP: ['DONE', 'BLOCKED'],
    DONE: [],
    BLOCKED: ['COOK', 'CHECK', 'FIX', 'PLAN', 'DONE'], // manual recovery or give up
});
