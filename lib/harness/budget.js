...
const DEFAULT_BUDGET = Object.freeze({
    ...
    maxConsecutiveTimeouts: 2, // stop loop early if agent hangs/timeouts repeatedly
});

function createBudget(overrides = {}) {
    const b = { ...DEFAULT_BUDGET, ...overrides };
    for (const k of ['maxIterations', 'maxWallclockMs', 'maxFixAttempts', 'maxAcceptanceRounds', 'maxCostUsd', 'maxConsecutiveTimeouts']) {
